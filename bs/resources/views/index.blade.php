...
<head>
    ...
    <link rel="icon" href="imgs/01-logo.ico" type="image/x-icon" />
...
<body>
            ...
            <nav class="navbar navbar-expand-sm fixed-top">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">
                        <img src="imgs/index/logo.jpg" class="rounded-circle" width="30px" height="30px"
                            alt="bobo">
                    </a>
        ...
        <div class="row justify-content-center fixed-top">
            ...
            <div class="col-6 mt-5">
                <a href="./index.html" class="fixed-icon ">
                    <img src="./imgs/index/marshmallow.png" alt="">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="row justify-content-center" style=" height: 100%; width: 100%;">
            <div class="col-8 mx-auto mt-5">
                <img src="./imgs/index/jump.gif" class="img-fluid" alt="GIF Example">
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-8 d-flex justify-content-center">
                <img src="./imgs/index/villagers.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
    ...
    <div class=" container mb-5">
        <div class="row">
                ...
                <div id="demo" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="./imgs/index/Carousel-1.jpg" class="d-block img-fluid" style="object-fit: cover;">
                        </div>
                        <div class="carousel-item">
                            <img src="./imgs/index/Carousel-2.jpg" class="d-block img-fluid"
                                style="object-fit: cover;">
                        </div>
                        <div class="carousel-item">
                            <img src="./imgs/index/Carousel-3.jpg" class="d-block img-fluid"
                                style="object-fit: cover;">
                        </div>
                        <div class="carousel-item">
                            <img src="./imgs/index/Carousel-4.jpg" class="d-block img-fluid"
                                style="object-fit: cover;">
                        </div>
                    </div>
            ...
            <div class="col d-flex justify-content-end mb-5">
                <div class="knit">
                    <img src="./imgs/index/knit cap.gif" class="img-fluid" alt="GIF Example">
                </div>
            </div>
            <!-- 右測空白欄 -->
            <div class="col">
    ...
    <div class="container-fluid">
        <div class="row mt-5 ">
            <div class="col mb-5 d-flex justify-content-center">
                <img src="./imgs/index/video.png" alt="map" style="width: 160px; height: auto;">
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row mt-5 ">
            <div class="col mb-5 d-flex justify-content-center">
                <img src="./imgs/index/map.png" alt="map" style="width: 150px; height: auto;">
            </div>
        </div>
    </div>
